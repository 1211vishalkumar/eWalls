...
public class SearchProductsActivity extends AppCompatActivity {
    ...
    private EditText edSearchProductName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edSearchProductName = findViewById(R.id.edSearchProductName);

        btnSearchProductName = findViewById(R.id.btnSearchProductName);

        /*rvSearchList = findViewById(R.id.rvSearchList);
        rvSearchList.setLayoutManager(new LinearLayoutManager(SearchProductsActivity.this));*/
        ...
        btnSearchProductName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                searchInput = edSearchProductName.getText().toString();
                onStart();
            }
        });
    }
    ...
    protected void onStart() {
        ...
        // in this we will be using firebase recycler Adapter
